 ...
 *
 * The confirmation is not decoration: addresses here are 42 characters and
 * visually similar, so "did that work?" is a real question, and re-clicking a
 * silent button is how someone ends up pasting the wrong address.
 *
